...
public class GamePlay extends JPanel implements KeyListener, ActionListener {
	...
	//fruit parameters
	private int [] fruitXpos = {25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 
			400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850};
	
	private int [] fruitYpos = {75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 
	...
	public void paint(Graphics g) {
		...
		titleImage.paintIcon(this, g, 175, 24);
		...
		for(int i = 1; i < lengthofsnake; i++) {
			if(snakeXlength[i] == snakeXlength[0] && snakeYlength[i] == snakeYlength[0]) {
				...
				g.drawString("GAME OVER! " + score, 250, 300);
